...
export const HISTORY_DOMAINS=['interactions','social','combat','equipment','property','robbery','crime','pursuit','village','registry','places','life','dialogue','opportunities','relations','economy','factions','standing','continuity']
...
const routine=new Set(['activity_changed','activity_arrived','activity_interrupted','activity_resumed','place_status_changed',
  ...
  'escort_route_seen','training_progress','recovery_progress'])
const pages=new Map()
