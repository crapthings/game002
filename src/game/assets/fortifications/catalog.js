export const fortificationCatalog = [
  ...
  { assetId: 'fort.gate', name: '四方雄关 · 重檐城门', category: 'fortification', zones: ['city'], tags: ['gate'], size: { width: 42, height: 29, depth: 28 }, description: '十二米宽贯通门洞，青石城台、朱柱、斗拱与双重飞檐；门扇常开。' },
