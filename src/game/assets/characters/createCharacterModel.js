import { createSurvivor } from '../../entities/createSurvivor.js'
...
const factories = { [PLAYER_ASSET_ID]: createPlayer, 'character.survivor': createSurvivor, ...Object.fromEntries(zombieDefinitions.map(definition => [`character.zombie.${definition.id}`, scene => createZombieModel(scene, definition)])) }
