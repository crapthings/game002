...
- [第一阶段统一验收入口](../docs/world-ledger/ACCEPTANCE.md)
- [因果回顾与角色知识](../docs/world-ledger/causal-review.md)
- [第一阶段实际实施说明与待验收项](../docs/world-ledger/first-loop.md)
- [合法道具、救助及延迟回礼](../docs/world-ledger/community-loop.md)
- [World Ledger 启动与分工](../docs/world-ledger/START_HERE.md)
- [已核实的仓库接口位置与未决项](../docs/world-ledger/REPO_INVENTORY.md)
- [模型与接口草案](../docs/world-ledger/proposal/contract.md)

按任务读取相关说明，再核对实际代码。这里记录的代码阅读结果不是运行验证；未获验证的实现、性能与玩法不得写成通过。
